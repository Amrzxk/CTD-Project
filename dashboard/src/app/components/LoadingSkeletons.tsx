      ...
      <Card className="bg-gray-800/50 border-gray-700">
        <CardContent className="py-6">
          <div className="grid md:grid-cols-3 gap-4">
            <Skeleton className="h-10 md:col-span-2 bg-gray-700/50" />
          ...
          <div className="space-y-4">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="flex gap-4">
                <Skeleton className="h-12 flex-1 bg-gray-700/50" />
              </div>
            ))}
          </div>
        </CardContent>
...
export function AnalyticsSkeleton() {
  return (
    <div className="space-y-6">
      {/* Header Skeleton */}
      <div className="space-y-2">
        <Skeleton className="h-10 w-80 bg-gray-700/50" />
        <Skeleton className="h-4 w-96 bg-gray-700/50" />
      </div>
        ...
        {[...Array(4)].map((_, i) => (
          <Card key={i} className="bg-gray-800/50 border-gray-700">
            <CardContent className="p-6">
              ...
              <Skeleton className="h-8 w-16 mb-1 bg-gray-700/50" />
